                        ...
                        <div class="overflow-hidden">
                          <table class="min-w-full">
                            ...
                            <tbody>
                              ...
                              <tr class="transition duration-300 ease-in-out hover:bg-yellow-100 hover:border-yellow-200 border-b text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap {{ $class }}">
                                  <td class="p-2">{{ $link->id }}</td>
                                  <td class="p-2 max-w-3xl truncate"><a target="_blank" class="text-blue-500" href="{{ $link->link }}">{{ $link->link }}</a></td>
